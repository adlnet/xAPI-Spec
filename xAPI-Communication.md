...
* <a name="4.0.s2.b1"></a>The LRS MUST handle making, or delegating, decisions on the validity of Statements, and 
determining what operations might be performed based on the credentials used (or lack therof).

<a name="security"></a>

## <a name="5.0">5.0</a> Security 

Security is beyond the 
...
While security concerns are beyond the scope of this specification, the xAPI Community remains dedicated to determining 
