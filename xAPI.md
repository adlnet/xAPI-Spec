...
* Values MUST be considered to be case sensitive unless specified otherwise. 
* Lowercase MUST be used to send case insensitive data.
...
* The LRS MUST treat all values as case sensitive unless specified otherwise.
