...
This specification uses JSON as a data binding.  While other bindings of xAPI could potentially exist, this document 
does not cover their implementation.

JSON data structures can use multiple serializations in xAPI. The reason this is relevant is because of Statement  <a href="#statement-immutablity-and-exceptions"> immutability </a>.  Statements that are <a href="#signature"> signed </a>are expected to maintain their original serialization before undergoing the signature process.
