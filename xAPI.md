...
###### Note: Due to query string limits, this method MAY be called using POST and
...
###### Note: For filter parameters which are not time or sequence based (that is, other than
