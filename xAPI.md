...
The xAPI community is in the process of drafting a set of security recommendations known collectively as [xAPISec](https://github.com/yetanalytics/xapisec). The memo is in early draft stage and contributions are welcome.
